            ...
            using (SqlCommand cmd = connection.CreateCommand())
            {
                ...
                using (SqlDataReader rdr = cmd.ExecuteReader())
                {
                    ...
                    while (rdr.Read())
                    {
                        ...
                        int idColumnPosition = rdr.GetOrdinal("Id");

                        // We user the reader's GetXXX methods to get the value for a particular ordinal.
                        int idValue = rdr.GetInt32(idColumnPosition);

                        int nameColumnPosition = rdr.GetOrdinal("Name");
                        string nameValue = rdr.GetString(nameColumnPosition);

                        int maxOccupancyColumPosition = rdr.GetOrdinal("MaxOccupancy");
                        int maxOccupancy = rdr.GetInt32(maxOccupancyColumPosition);
